...
pub struct Transaction {
    ...
    pub signatures: Vec<picomint_core::secp256k1::schnorr::Signature>,
}
...
impl Transaction {
    pub const MAX_TX_SIZE: usize = picomint_core::config::ALEPH_BFT_UNIT_BYTE_LIMIT - 32;
    ...
    pub fn validate_signatures(
        &self,
        pub_keys: &[picomint_core::secp256k1::PublicKey],
    ) -> Result<(), TransactionError> {
        use picomint_core::secp256k1;
