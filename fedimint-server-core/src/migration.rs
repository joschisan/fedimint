...
use fedimint_core::db::{
    Database, DatabaseVersion, DbMigrationFn, DbMigrationFnContext, NonCommittable,
    WriteDatabaseTransaction, apply_migrations_dbtx,
};
...
pub trait IServerDbMigrationContext {
    ...
    async fn get_module_history_stream<'s, 'tx>(
        ...
        dbtx: &'s mut WriteDatabaseTransaction<'tx, NonCommittable>,
