...
//! [`picomint_client_module::module::ClientModule`] trait and a factory struct
//! implementing [`picomint_client_module::module::init::ClientModuleInit`]. The
...
//! return a deposit address and a [`picomint_client_module::OperationId`]
...
//! context](picomint_client_module::module::ClientModule::context).
//!
...
//! [`picomint_client_module::ClientModule::supports_being_primary`] and related
//! methods.
//!
...
pub use picomint_client_module as module;
/// Re-exporting of everything from `picomint_client_module`
///
/// This should be removed when the splitting of [`picomint_client_module`] is
/// complete.
pub use picomint_client_module::*;
