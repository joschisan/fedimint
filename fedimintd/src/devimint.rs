...
pub const INIT_SETUP_ENDPOINT: &str = "init_setup";
pub const ADD_SETUP_CODE_ENDPOINT: &str = "add_setup_code";
...
pub fn setup_start(
    ...
    let app = Router::new()
        .route(&format!("/{INIT_SETUP_ENDPOINT}"), post(init_setup))
        .route(&format!("/{ADD_SETUP_CODE_ENDPOINT}"), post(add_setup_code))
        .route(&format!("/{START_DKG_ENDPOINT}"), post(start_dkg))
