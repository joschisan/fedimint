...
use picomint_logging::LOG_CLIENT_MODULE_WALLETV2;
use picomint_redb::Database;
use picomint_walletv2_common::config::WalletClientConfig;
    ...
    fn spawn_output_scanner(&self, task_group: &TaskGroup) {
        ...
        task_group.spawn_cancellable("output-scanner", async move {
            ...
            loop {
                ...
                sleep(picomint_walletv2_common::sleep_duration()).await;
            }
        });
    }
